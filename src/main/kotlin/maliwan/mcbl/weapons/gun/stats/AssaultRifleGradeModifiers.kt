 ...
 */
object AssaultRifleGradeModifiers : ModifierProvider, StandardDeviationProvider {

    private val baseModifierTable = TabTable.fromResource(
        "/gun/base/assault-rifle-grade-modifiers.csv",
        Rarity::valueOf,
        { it },
        { it }
    )
    ...
    private val modifierStandardDeviationTable = TabTable.fromResource(
        "/gun/base/assault-rifle-grade-modifiers-std.csv",
        Rarity::valueOf,
        { it },
        { it.toDouble() }
    )
