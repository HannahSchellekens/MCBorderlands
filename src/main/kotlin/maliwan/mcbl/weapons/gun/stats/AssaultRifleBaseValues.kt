 ...
 */
object AssaultRifleBaseValues : BaseValueProvider {

    private val baseValueTable = TabTable.fromResource(
        "/gun/base/assault-rifle-base-values.csv",
    ...
    /**
     * Creates a new [GunProperties] object for assault rifles that is populated by the base values of `manufacturer`.
