 ...
 */
object LauncherGradeModifiers : ModifierProvider, StandardDeviationProvider {

    private val baseModifierTable = TabTable.fromResource(
        "/gun/base/launcher-grade-modifiers.csv",
        Rarity::valueOf,
        { it },
        { it }
    )
    ...
    private val modifierStandardDeviationTable = TabTable.fromResource(
        "/gun/base/launcher-grade-modifiers-std.csv",
        Rarity::valueOf,
        { it },
        { it.toDouble() }
    )
